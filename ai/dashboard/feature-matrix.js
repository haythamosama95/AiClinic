      ...
      features: [
        {
          ...
          auth: 'none',
          headers: JSON_HEADERS,
          body: { task: 'command', prompt: 'hello', context: buildGenerateContext() },
        ...
        },
        {
          ...
          auth: 'jwt',
          headers: JSON_HEADERS,
          body: { task: 'command', prompt: '', context: buildGenerateContext() },
        ...
        },
        {
          ...
          auth: 'jwt',
          headers: JSON_HEADERS,
          body: { task: 'plan', prompt: 'book Ahmed tomorrow', context: buildGenerateContext() },
        ...
        },
        {
          ...
          auth: 'jwt',
          headers: JSON_HEADERS,
          body: { task: 'command', prompt: OVERSIZED_PROMPT, context: buildGenerateContext() },
          expect: { status: 400, error_code: 'bad_request' },
