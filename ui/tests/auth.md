...
| `page explains administrators reset passwords from settings staff`             | Forgot-password panel open                                              | Copy mentions Settings, Staff, Reset password, and administrator account                                                               | Required administrator guidance missing                                     |
