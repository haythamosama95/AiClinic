...
String appointmentMessageForRpc(RpcFailure failure) {
  return switch (failure.code) {
    'SCHEDULE_CONFLICT' =>
      'This time overlaps another booked slot. Choose a different slot.',
    ...
    'VISIT_IN_PROGRESS' =>
      'Cannot undo while a visit exists for this appointment. Complete or cancel the visit first.',
    ...
    'NOT_FOUND' => switch (failure.message.toLowerCase()) {
      final message when message.contains('patient') =>
        'Patient was not found.',
      final message when message.contains('appointment') =>
