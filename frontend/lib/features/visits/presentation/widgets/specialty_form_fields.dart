  ...
  Widget build(BuildContext context) {
    ...
    if (field.isSelect) {
      ...
      return AppSelect<String>(
        ...
        items: {for (final option in field.enumValues) option: option},
        value: field.enumValues.contains(selected) ? selected : null,
        enabled: widget.enabled,
    ...
    return AppTextField(
      ...
      validator: widget.errorText == null ? null : (_) => widget.errorText,
      onChanged: (text) {
