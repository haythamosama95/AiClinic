...
final shiftDetailProvider = AsyncNotifierProvider.autoDispose
    .family<ShiftDetailNotifier, ShiftDetailState, String>(ShiftDetailNotifier.new);
      ...
      if (error.code == 'stale_shift') {
        state = AsyncData(
          currentAfter.copyWith(
            mutationStatus: ShiftDetailMutationStatus.stale,
            mutationError: shiftMessageForRpc(error),
          ),
        );
        return false;
      }
