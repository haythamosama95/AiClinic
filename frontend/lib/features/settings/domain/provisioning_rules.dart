...
abstract final class ProvisioningRules {
  ...
  ///
  /// Distinct from [canResetStaffPassword] so a future change to password-reset
  /// authorization does not silently broaden username updates (review §5.8).
  /// Today both require the clinic administrator role.
