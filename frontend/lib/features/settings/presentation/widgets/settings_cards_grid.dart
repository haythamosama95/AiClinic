...
/// Two-column layout for [SettingsSectionCard] widgets (half width each).
class SettingsCardsGrid extends StatelessWidget {
  const SettingsCardsGrid({required this.children, this.compactBreakpoint = compactBreakpointDefault, super.key});
