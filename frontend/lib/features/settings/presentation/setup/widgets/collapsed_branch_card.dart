...
class CollapsedBranchCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _CollapsedBranchEnterTransition(
      child: Row(
...
class _CollapsedBranchEnterTransition extends StatelessWidget {
  const _CollapsedBranchEnterTransition({required this.child});
