...
/// Minimal staff account creation form on `/staff/create` (US6).
        ...
        return AppDialog(
          ...
          footer: Row(
            ...
            children: [
              ...
              AppButton(label: 'Done', onPressed: () => close()),
            ],
          ),
        );
      },
      ...
      return Scaffold(
        body: AppAsyncStateView(
          ...
          config: const AppContentStateConfig(
            noAccessTitle: 'Create staff',
            noAccessDescription: 'Only clinic administrators can create staff accounts.',
          ),
          ...
          EditorFormSection(
            ...
            fields: [
              if (branchIds.isEmpty)
                ...
                AppAsyncStateView(
                  state: branchesAsync.isLoading
                      ? AppContentState.loading
                      : branchesAsync.hasError
                      ? AppContentState.error
                      : AppContentState.ready,
                  config: AppContentStateConfig(
                    errorTitle: 'Unable to load branches',
                    errorMessage: 'Could not load branch details. Showing branch IDs only.',
                  ),
                  child: Column(
