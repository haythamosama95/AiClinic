    ...
    return RpcFailure(
      RpcResult(
        ...
        errorMessage:
            ...
            '(for example visit documentation, patients, or billing settings). Apply migration '
            '20260630120000_dev_reset_delete_visit_documentation.sql, restart Supabase, and try again.',
      ),
    );
  }
