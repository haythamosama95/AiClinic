...
class OrganizationRepositoryImpl with AppRpcInvoker, ClinicManagementRpcInvoker implements OrganizationRepository {
  ...
  Future<String> updateOrganization(UpdateOrganizationInput input) async {
    ...
    final result = await invokeClinicManagementRpc('update_organization', {
      'p_name': name,
