...
/// Steady-state role permission matrix reads and administrator updates.
class RolePermissionsRepositoryImpl with AppRpcInvoker, ClinicManagementRpcInvoker implements RolePermissionsRepository {
  ...
  Future<void> updateRolePermission({
    ...
    await invokeClinicManagementRpc('update_role_permission', {
  ...
  Future<void> updateRolePermissions(Iterable<PermissionMatrixChange> changes) async {
    ...
    await invokeClinicManagementRpc('update_role_permissions', {'p_changes': payload});
  }
}
