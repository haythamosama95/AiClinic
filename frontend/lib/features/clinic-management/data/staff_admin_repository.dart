...
class StaffAdminRepositoryImpl with AppRpcInvoker, ClinicManagementRpcInvoker implements StaffAdminRepository {
  ...
  Future<String> updateStaffMember(UpdateStaffMemberInput input) async {
    ...
    final result = await invokeClinicManagementRpc('update_staff_member', {
  ...
  Future<RpcResult> setStaffActive({required String staffMemberId, required bool isActive}) {
    return invokeClinicManagementRpc('set_staff_active', {'p_staff_member_id': staffMemberId, 'p_is_active': isActive});
  }

  @override
  Future<RpcResult> deleteStaffMember({required String staffMemberId}) {
    return invokeClinicManagementRpc('delete_staff_member', {'p_staff_member_id': staffMemberId});
  }
}
