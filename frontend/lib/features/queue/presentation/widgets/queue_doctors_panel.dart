            ...
            Flexible(
              child: ConstrainedBox(
                constraints: BoxConstraints(
                  maxHeight: embedded ? 448 : double.infinity,
                ),
...
class _DoctorRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final status = inProgress == null
        ? _DoctorQueueStatus.available
        : _DoctorQueueStatus.withPatient;
    ...
    final idle = status == _DoctorQueueStatus.available
        ? queueDoctorIdleMinutes(doctor, appointments, now: now)
        : 0;
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.space2),
          AppProgress(
            value: (patientsSeenToday * 12).clamp(0, 100).toDouble(),
