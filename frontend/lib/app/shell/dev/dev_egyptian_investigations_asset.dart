...
/// Bundled Egyptian investigation names for dev clinic seeding.
///
/// Schema matches [investigations.name] (max 200 chars, case-insensitive unique per org).
abstract final class DevEgyptianInvestigationsAsset {
  static const assetPath = 'assets/dev/egyptian_investigation_names.json';
  ...
  static Future<List<String>> loadNames() async {
    ...
    if (decoded is! Map<String, dynamic>) {
      throw StateError('Egyptian investigation asset must be a JSON object.');
    }
