...
export 'package:ai_clinic/features/settings/data/branch_repository.dart'
    show branchRepositoryProvider;
export 'package:ai_clinic/features/settings/data/staff_admin_repository.dart'
    show staffAdminRepositoryProvider;
export 'package:ai_clinic/features/patients/data/patient_repository.dart'
    show patientRepositoryProvider;
