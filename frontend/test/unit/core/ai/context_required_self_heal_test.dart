...
void main() {
  group('context_required self-heal', () {
    test(
      'stale_client_context_required_refreshes_resolves_resubmits_once_same_idempotency_key_and_succeeds',
      () async {
        ...
        final submit = FakeSubmitPort(
          script: [
            ...
            SubmitOpenStreamStep(
              completedStream(requestReference: 'req-healed-success'),
            ),
          ],
        );
    ...
    test(
      'second_context_required_stops_and_surfaces_request_reference',
      () async {
    ...
    test(
      'no_automatic_third_attempt_after_second_context_required',
      () async {
    ...
    test(
      'conversational_capabilities_never_take_context_required_self_heal_path',
      () async {
        final mint = FakeMintPort();
        final submit = FakeSubmitPort(
          script: [
