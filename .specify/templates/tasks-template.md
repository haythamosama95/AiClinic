...
**Tests**: The examples below include test tasks. Tests are OPTIONAL unless explicitly
requested in the feature specification or needed to prove constitution-sensitive
behavior such as RLS, RPC validation, auditability, or AI approval gating.
...
**Purpose**: Project initialization and architecture-safe structure
...
- [ ] TXXX [P] Documentation updates in docs/ or docs/specs/
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional unit tests (if requested) in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Review constitution compliance for final architecture and operations
...
- Preserve layer boundaries: do not move domain authority into Flutter or AI
- Keep protected writes, audit requirements, and approval gates explicit in the task list
