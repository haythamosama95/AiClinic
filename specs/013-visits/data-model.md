...
Builds on V1-5 (`specs/006-visit-medical-records/data-model.md`). Replaces SOAP/specialty documentation; adds catalogs and visit child records. Attachments and visit lifecycle unchanged.
