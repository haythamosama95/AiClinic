...
- [ ] T003 [P] [US1] Write `ai-platform/test/health.test.ts` — T2
      ...
      endpoint.
- [ ] T004 [P] [US1] Write `ai-platform/test/env-deploys.test.ts` — T1
      ...
      real.
- [ ] T005 [P] [US1] Add to `ai-platform/test/env-deploys.test.ts` — T3
...
- [ ] T006 [P] [US1] Add to `ai-platform/test/env-deploys.test.ts` — T4
...
- [ ] T007 [US1] Implement the startup binding-presence check in `ai-platform/src/worker.ts`: at
...
- [ ] T008 [US1] Implement the health endpoint in `ai-platform/src/worker.ts`: a `fetch` handler
...
- [ ] T009 [US1] Run the full A1 suite (`vitest run` in `ai-platform/`) and confirm T1–T4 are
...
- [ ] T010 [P] [US1] Write `specs/015-ai-worker-skeleton/quickstart.md`: the exact commands a
...
- [ ] T011 [P] [US1] Write `ai-platform/README.md`: one paragraph orienting future readers to the
