...
**Branch**: `014-visit-encounter-workspace` | **Date**: 2026-06-30 | **Spec**: `specs/014-visit-encounter-workspace/spec.md`

**Input**: Feature specification from `specs/014-visit-encounter-workspace/spec.md`
...
```text
specs/014-visit-encounter-workspace/
├── plan.md              # This file
