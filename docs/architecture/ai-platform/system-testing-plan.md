...
| SYS-1.5 | Discovery after entitle | `manifests[0]` carries full field set (`Identity`, `Access`, `Interaction`, `Input`, `Routing.routingPolicyRef="routing/standard@v1"`, `Economics`, `Governance`); `ETag` present; second GET with `If-None-Match` → 304 empty body (DJ-09 §6.3.4–6). |
