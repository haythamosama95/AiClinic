...
| **Network partition (LAN)**        | Client connection timeout      | Affected PCs cannot access Supabase                               | Users work from the receptionist PC directly, or wait for network restore.                                  |
