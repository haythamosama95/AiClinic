...
| **Cost ceiling**    | Is this single request too expensive?      | Local estimate        | A pre-flight estimate against the capability's budget, before any egress.                                                                    |
...
| 15  | **Cost pre-flight**              | Estimates input tokens from the intent, adds the capability's max output tokens, and compares the total against the capability's per-request cost ceiling.                                                                                                                                                                    | —                                                                                        |
