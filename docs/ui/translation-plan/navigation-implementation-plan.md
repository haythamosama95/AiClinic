...
> ⚠️ **Read [`docs/ui/memory/ui-runtime-errors.md`](../memory/ui-runtime-errors.md) end-to-end first.** Five widgets in this group risk the regressions catalogued there. Apply the checklist items by number while implementing:
>
