...
- Spec: `docs/specs/007-billing/spec.md`
- Constitution: `.specify/memory/constitution.md`
- V1-2 settings page conventions: `docs/specs/003-org-branch-management`
- V1-5 RPC + RLS pattern: `docs/specs/006-visit-medical-records/data-model.md`, `contracts/visit-mutations.md`
