...
**Input**: Design documents from `/docs/specs/007-billing/`
...
- [X] T069 [P] Documentation: append a short "Billing" section to any operator-facing notes in `docs/architecture/` if such conventions exist; reference `docs/specs/operations/billing.spec.md` placeholder per FR-026
...
- [X] T072 Walk through `docs/specs/007-billing/quickstart.md` against a fresh local Supabase + Flutter build; record any deviations and file follow-up issues
