...
**Deviations / follow-ups:** None blocking. `docs/specs/operations/billing.spec.md` remains unauthored (FR-026 placeholder). Manual steps 8 (OS print dialog) and 10 (two-station UI race) should be recorded in a release checklist when cutting a clinic build.
