...
**Branch**: `006-visit-medical-records` | **Date**: 2026-05-31 | **Spec**: `docs/specs/006-visit-medical-records/spec.md`

**Input**: Feature specification from `/docs/specs/006-visit-medical-records/spec.md`
...
```text
`docs/specs/006-visit-medical-records/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
