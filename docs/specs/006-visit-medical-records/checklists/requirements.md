...
- `docs/specs/operations/visits.spec.md` is referenced by the roadmap but is not yet present; this feature spec is authoritative for V1-5 until that shared spec is authored.
