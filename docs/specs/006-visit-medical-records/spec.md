...
**Feature Branch**: `006-visit-medical-records`
...
- **FR-026**: The system MUST derive requirements from the architecture documents listed under Required Architecture Docs and treat `docs/specs/operations/visits.spec.md` as an external reference until authored.
...
- `docs/specs/operations/visits.spec.md` is referenced by the roadmap but is not yet present. This specification captures visit and medical record expectations for V1-5 until that shared operations spec is authored.
- `docs/specs/005-appointment-management` is a hard prerequisite: checked-in and in-progress appointments, patient/doctor linkage, and branch context must exist. V1-5 extends appointment completion semantics as documented in Clarifications.
- `docs/specs/004-patient-management` is a hard prerequisite: patient registry and patient profile views must exist.
...
- MUST build on completed `docs/specs/002-auth-rbac`, `docs/specs/003-org-branch-management`, `docs/specs/004-patient-management`, and `docs/specs/005-appointment-management`.
...
- `docs/specs/002-auth-rbac`, `docs/specs/003-org-branch-management`, `docs/specs/004-patient-management`, and `docs/specs/005-appointment-management` are implemented.
...
- `docs/specs/operations/visits.spec.md` will be authored later; this feature spec is authoritative for V1-5 until that shared spec exists.
