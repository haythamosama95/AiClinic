...
- Spec: `docs/specs/008-shift-management/spec.md`
- Constitution: `.specify/memory/constitution.md`
- V1-4 calendar + timezone patterns: `docs/specs/005-appointment-management`
- V1-2 staff/branch assignments: `docs/specs/003-org-branch-management`
- V1-1 permission seed (`shifts.manage`): `docs/specs/002-auth-rbac/data-model.md`
