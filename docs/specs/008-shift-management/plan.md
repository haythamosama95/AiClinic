...
**Branch**: `008-shift-management` | **Date**: 2026-06-06 | **Spec**: `docs/specs/008-shift-management/spec.md`

**Input**: Feature specification from `/docs/specs/008-shift-management/spec.md`
...
```text
`docs/specs/008-shift-management/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
