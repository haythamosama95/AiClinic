...
**Input**: Design documents from `/docs/specs/001-project-scaffolding/`
...
- **Documentation**: `docs/setup/`, `docs/specs/001-project-scaffolding/`
...
- [X] T024 [US2] Align the feature quickstart and deployment profile contract with the final setup docs in `docs/specs/001-project-scaffolding/quickstart.md` and `docs/specs/001-project-scaffolding/contracts/deployment-profile.md`
...
- [X] T032 [US3] Document quality-gate commands and shared foundation usage in `docs/setup/quality-gates.md` and `docs/specs/001-project-scaffolding/quickstart.md`
...
- T034 Run the full quickstart validation and capture final acceptance notes in `docs/specs/001-project-scaffolding/quickstart.md`
- T035 Review final constitution compliance and update implementation notes in `docs/specs/001-project-scaffolding/plan.md` and `docs/specs/001-project-scaffolding/tasks.md`
