...
- **Decision**: Use `docs/architecture/03-deployment-networking.md` and the active feature spec as the temporary source of truth for deployment and setup expectations until `docs/specs/common/deployment-installer.spec.md` exists.
