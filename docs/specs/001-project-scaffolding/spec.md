...
- `docs/specs/common/deployment-installer.spec.md` is referenced by the roadmap as a shared dependency but is not yet present. This specification therefore captures the minimum deployment and setup expectations required for V1-0 until the shared deployment specification is authored.
