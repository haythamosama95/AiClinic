...
- `docs/specs/operations/appointments.spec.md` is referenced by the roadmap but is not yet present; this feature spec is authoritative for V1-4 until that shared spec is authored.
