...
**Branch**: `005-appointment-management` | **Date**: 2026-05-24 | **Spec**: `docs/specs/005-appointment-management/spec.md`

**Input**: Feature specification from `/docs/specs/005-appointment-management/spec.md`
...
```text
`docs/specs/005-appointment-management/
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
