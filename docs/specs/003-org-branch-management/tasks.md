...
**Input**: Design documents from `/docs/specs/003-org-branch-management/`

**Prerequisites**: plan.md, spec.md, research.md, data-model.md, contracts/, quickstart.md; **V1-1** (`docs/specs/002-auth-rbac`) complete
...
- **Contracts**: `docs/specs/003-org-branch-management/contracts/`
...
- [x] T054 [P] Run full `docs/specs/003-org-branch-management/quickstart.md` flow and document any gaps in `docs/specs/003-org-branch-management/quickstart.md`
...
- [x] T056 Run V1-1 regression: bootstrap, login, idle timeout, subscription non-blocking per `docs/specs/002-auth-rbac/quickstart.md`
- [x] T057 [P] Add admin settings section to `docs/setup/` linking organization, branch, staff, and permissions screens
- [x] T058 Verify no soft-delete UI for branches/staff (FR-018a) via manual checklist in `docs/specs/003-org-branch-management/spec.md` acceptance criteria
- [x] T059 [P] Confirm `build_staff_claims` excludes inactive branches (no code change if already correct) and document in `docs/specs/003-org-branch-management/research.md` Decision 5 verification note
