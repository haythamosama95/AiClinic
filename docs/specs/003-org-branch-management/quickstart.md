...
Implementation and verification for **V1-2**. Requires completed **V1-1** (`docs/specs/002-auth-rbac`).
...
- Prior auth/RBAC migrations from `docs/specs/002-auth-rbac` (schema, RLS, `build_staff_claims`, bootstrap RPCs)
...
| Full V1-1 idle-timeout E2E                               | Partial                      | `session_lifecycle_test.dart` + manual table in `docs/specs/002-auth-rbac/quickstart.md` §5       |
...
| Doc          | Path                                         |
| ------------ | -------------------------------------------- |
| Spec         | `docs/specs/003-org-branch-management/spec.md`    |
| Plan         | `docs/specs/003-org-branch-management/plan.md`    |
| Contracts    | `docs/specs/003-org-branch-management/contracts/` |
| Prerequisite | `docs/specs/002-auth-rbac/quickstart.md`          |
