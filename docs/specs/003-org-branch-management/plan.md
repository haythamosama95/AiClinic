...
**Branch**: `003-org-branch-management` | **Date**: 2026-05-21 | **Spec**: `docs/specs/003-org-branch-management/spec.md`

**Input**: Feature specification from `/docs/specs/003-org-branch-management/spec.md`
...
```text
`docs/specs/003-org-branch-management/
├── plan.md              # This file
├── research.md          # Phase 0
