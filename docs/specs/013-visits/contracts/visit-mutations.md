...
Replaces `docs/specs/006-visit-medical-records/contracts/visit-mutations.md` visit documentation sections. `create_visit`, attachment RPCs, and visit completion coupling unchanged unless noted.
