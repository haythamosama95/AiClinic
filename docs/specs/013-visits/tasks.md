...
**Input**: Design documents from `/docs/specs/013-visits/`
...
- [X] T001 Create migration scaffold `backend/supabase/migrations/20260628140000_visit_documentation_redesign.sql` with header comments referencing `docs/specs/013-visits/plan.md` `backend/supabase/migrations/20260628140000_visit_documentation_redesign.sql` with header comments referencing `docs/specs/013-visits/plan.md`
...
- [X] T008 [P] Implement catalog RPCs (`search_medications`, `search_investigations`, `list_predefined_vital_signs`, `create_catalog_medication`, `create_catalog_investigation`, `create_predefined_vital_sign`) per `docs/specs/013-visits/contracts/catalog-queries.md` in `backend/supabase/migrations/20260628140000_visit_documentation_redesign.sql`
- [X] T009 [P] Implement vital sign CRUD RPCs (`create_visit_vital_sign`, `update_visit_vital_sign`, `archive_visit_vital_sign`) per `docs/specs/013-visits/contracts/visit-mutations.md` in `backend/supabase/migrations/20260628140000_visit_documentation_redesign.sql`
- [X] T010 [P] Implement investigation CRUD RPCs (`create_visit_investigation`, `update_visit_investigation`, `archive_visit_investigation`) per `docs/specs/013-visits/contracts/visit-mutations.md` in `backend/supabase/migrations/20260628140000_visit_documentation_redesign.sql`
- [X] T011 Update `get_visit` to return `documentation`, `vital_signs`, `investigations` payload (remove `soap`/`specialty_form_json`) per `docs/specs/013-visits/contracts/visit-queries.md` in `backend/supabase/migrations/20260628140000_visit_documentation_redesign.sql`
...
- [ ] T060 Execute manual regression from `docs/specs/013-visits/quickstart.md` (appointment create/open visit, patient visit history metadata, catalog search SC-002)
