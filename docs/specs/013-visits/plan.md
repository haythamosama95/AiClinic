...
**Branch**: `ui/013-visits` | **Date**: 2026-06-28 | **Spec**: `docs/specs/013-visits/spec.md`

**Input**: Feature specification from `docs/specs/013-visits/spec.md`
