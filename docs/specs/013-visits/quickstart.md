...
Requires **V1-5** visits (`docs/specs/006-visit-medical-records`) applied. This feature replaces documentation UI and SOAP storage.
...
| Doc | Path |
| --- | ---- |
| Spec | `docs/specs/013-visits/spec.md` |
| Plan | `docs/specs/013-visits/plan.md` |
| Data model | `docs/specs/013-visits/data-model.md` |
| Contracts | `docs/specs/013-visits/contracts/` |
