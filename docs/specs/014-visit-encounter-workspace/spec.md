...
- This feature builds directly on feature 013 (`docs/specs/013-visits`); the 013 clinical-note model, catalogs, child records, attachments, permissions, optimistic concurrency, and lifecycle are the foundation and are not changed by the redesign.
