...
**Input**: Design documents from `/docs/specs/014-visit-encounter-workspace/`
...
- [X] T070 Verify SC-005 (100% 013 fields reachable, none duplicated), SC-008 (attachment regression), and submission rules unchanged per `docs/specs/014-visit-encounter-workspace/quickstart.md`
