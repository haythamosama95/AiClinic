...
**Input**: Design documents from `/docs/specs/002-auth-rbac/`
...
- [X] T023 [US8] Complete authenticated vs unauthenticated redirect rules in `frontend/lib/app/router.dart` per `docs/specs/002-auth-rbac/contracts/auth-session.md`
...
- [X] T061 Run full `docs/specs/002-auth-rbac/quickstart.md` validation and update acceptance notes in `docs/specs/002-auth-rbac/quickstart.md`
- [X] T062 [P] Align `docs/specs/002-auth-rbac/contracts/` with final RPC signatures if implementation diverges during build
- [X] T063 Review constitution compliance and mark post-implementation notes in `docs/specs/002-auth-rbac/plan.md`
