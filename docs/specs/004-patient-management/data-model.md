...
Introduces `public.patients` (V1-3). Builds on V1-1/V1-2 tenancy tables from `docs/specs/002-auth-rbac/data-model.md` and `docs/specs/003-org-branch-management/data-model.md`.
