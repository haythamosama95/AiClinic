...
**Feature Branch**: `004-patient-management`
...
- **FR-017**: The system MUST derive requirements from the architecture documents listed under Required Architecture Docs and treat `docs/specs/operations/patients.spec.md` as an external reference until authored.
...
- `docs/specs/operations/patients.spec.md` is referenced by the roadmap but is not yet present. This specification captures patient management expectations for V1-3 until that shared operations spec is authored.
- `docs/specs/003-org-branch-management` is a hard prerequisite: active branch context, branch switcher, staff permissions, and organization/branch administration must already be delivered.
- `docs/specs/002-auth-rbac` is a hard prerequisite: authentication, JWT claims, RLS foundation, and session management must already be delivered.
...
- MUST build on completed `docs/specs/002-auth-rbac` and `docs/specs/003-org-branch-management` without breaking authentication or administration flows.
...
- `docs/specs/002-auth-rbac` and `docs/specs/003-org-branch-management` are implemented: session, claims, active branch, permissions, and administration exist.
...
- `docs/specs/operations/patients.spec.md` will be authored later; this feature spec is authoritative for V1-3 until that shared spec exists.
