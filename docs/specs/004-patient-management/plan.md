...
**Branch**: `004-patient-management` | **Date**: 2026-05-23 | **Spec**: `docs/specs/004-patient-management/spec.md`

**Input**: Feature specification from `/docs/specs/004-patient-management/spec.md`
...
```text
`docs/specs/004-patient-management/
├── plan.md              # This file
├── research.md          # Phase 0
