...
**Branch**: `015-service-catalog` | **Date**: 2026-07-02 | **Spec**: `docs/specs/015-service-catalog/spec.md`

**Input**: Feature specification from `docs/specs/015-service-catalog/spec.md`
...
```text
`docs/specs/015-service-catalog/
├── plan.md              # This file
