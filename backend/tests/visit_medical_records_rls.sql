...
BEGIN
  ...
  VALUES
    (v_patient_a, v_branch_a, v_org_a, 'Patient A', '201111111251', 'MRN-250001', v_user_a, v_user_a),
    (v_patient_a2, v_branch_a2, v_org_a, 'Patient A2', '201111111252', 'MRN-250002', v_user_a, v_user_a),
    (v_patient_b, v_branch_b, v_org_b, 'Patient B', '201234567951', 'MRN-250003', v_user_b, v_user_b);
