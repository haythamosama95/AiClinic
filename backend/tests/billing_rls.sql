...
BEGIN
  ...
  VALUES
    (v_patient_a, v_branch_a, v_org_a, 'Patient A', '201111111261', 'MRN-260001', v_user_owner, v_user_owner),
    (v_patient_a2, v_branch_a2, v_org_a, 'Patient A2', '201111111262', 'MRN-260002', v_user_owner, v_user_owner),
    (v_patient_b, v_branch_b, v_org_b, 'Patient B', '201234567961', 'MRN-260003', v_user_owner_b, v_user_owner_b);
