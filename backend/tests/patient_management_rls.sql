...
BEGIN
  ...
  VALUES
    (v_patient_a, v_branch_a, v_org_a, 'Org A Patient', '201111111111', 'MRN-702001', v_user_a, v_user_a),
    (v_patient_b, v_branch_b, v_org_b, 'Org B Patient', '201234567890', 'MRN-702002', v_user_b, v_user_b);
