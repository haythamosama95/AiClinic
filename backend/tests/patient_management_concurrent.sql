...
BEGIN
  ...
  VALUES (v_patient1_id, v_org_id, v_branch_id, 'Patient One', '01001234567', 'MRN-703001', false, v_bootstrap_user, v_bootstrap_user);

  -- Attempt to insert second patient with the same phone in same org
  BEGIN
    v_patient2_id := gen_random_uuid();
    INSERT INTO public.patients (id, organization_id, branch_id, full_name, phone, mrn, is_deleted, created_by, updated_by)
    VALUES (v_patient2_id, v_org_id, v_branch_id, 'Patient Two', '01001234567', 'MRN-703002', false, v_bootstrap_user, v_bootstrap_user);
  EXCEPTION
  ...
  BEGIN
    INSERT INTO public.patients (id, organization_id, branch_id, full_name, phone, mrn, is_deleted, created_by, updated_by)
    VALUES (gen_random_uuid(), 'd1000000-0000-4000-8000-000000000c99', 'd2000000-0000-4000-8000-000000000c99', 'Patient Other Org', '01001234567', 'MRN-703099', false, v_bootstrap_user, v_bootstrap_user);
  EXCEPTION
    WHEN unique_violation THEN
      v_got_violation := true;
  END;
  ...
  BEGIN
    INSERT INTO public.patients (id, organization_id, branch_id, full_name, phone, mrn, is_deleted, created_by, updated_by)
    VALUES (gen_random_uuid(), v_org_id, v_branch_id, 'Patient Replacement', '01001234567', 'MRN-703003', false, v_bootstrap_user, v_bootstrap_user);
  EXCEPTION
    WHEN unique_violation THEN
      v_got_violation := true;
  END;
