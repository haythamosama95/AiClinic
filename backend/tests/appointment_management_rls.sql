...
BEGIN
  ...
  VALUES
    (v_patient_a, v_branch_a, v_org_a, 'Patient A', '201111111141', 'MRN-240001', v_user_a, v_user_a),
    ('a2400000-0000-4000-8000-0000000000a2', v_branch_a2, v_org_a, 'Patient A2', '201111111142', 'MRN-240002', v_user_a, v_user_a),
    (v_patient_b, v_branch_b, v_org_b, 'Patient B', '201234567891', 'MRN-240003', v_user_b, v_user_b);
