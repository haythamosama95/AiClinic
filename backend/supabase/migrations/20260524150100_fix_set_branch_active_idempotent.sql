...
-- Returns success without writing an audit entry when the branch is already in the target state.
...
BEGIN
  ...
  -- No-op if already in target state (avoid redundant audit entries)
