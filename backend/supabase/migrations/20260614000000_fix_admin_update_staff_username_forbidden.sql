-- Return rpc_error on FORBIDDEN from assert_owner_or_administrator (parity with create_staff_account).
...
EXCEPTION
  ...
  WHEN OTHERS THEN
    IF SQLERRM = 'FORBIDDEN' THEN
      RETURN public.rpc_error('FORBIDDEN', 'You do not have permission to update staff usernames.');
    END IF;
    RAISE;
END;
$$;
