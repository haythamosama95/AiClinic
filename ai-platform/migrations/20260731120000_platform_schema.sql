-- Platform D1 schema (§7.3): forward-only additive migration for slice A5.
-- request_reference stores the A2 RequestReference format unchanged (XXXX-XXXX, eight Crockford-base32 symbols).
...
CREATE TABLE ai_request (
  ...
  -- A2 RequestReference format: XXXX-XXXX (eight Crockford-base32 symbols, stored unchanged).
